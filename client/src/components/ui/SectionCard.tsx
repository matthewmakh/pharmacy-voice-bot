...
export default function SectionCard({
  ...
  return (
    <section className={`bg-card text-card-foreground rounded-xl border border-border shadow-sm overflow-hidden ${className}`}>
      {hasHeader && (
        <header
        ...
        >
          {icon && <div className="shrink-0 text-muted-foreground mt-0.5">{icon}</div>}
