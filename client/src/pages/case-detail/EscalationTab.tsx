...
/**
 * Escalation as a guided mini-stepper. The existing panels are reused untouched as
 ...
 *
 * Phase A/B steps are woven into the same spine: the SCRA non-military affidavit sits with
 * the default-judgment package, and handing off to an attorney is an optional exit.
 */
export default function EscalationTab({ caseData }: { caseData: Case }) {
  ...
  const steps: Step[] = [
    ...
    {
      id: 'scra',
      title: 'Non-military (SCRA) affidavit',
      done: !!caseData.scraAffidavitHtml,
      locked: !served,
      lockMsg: 'Unlocks after the defendant is served',
      optional: true,
      render: () => <SCRAPanel caseData={caseData} />,
    },
    {
      id: 'judgment',
    ...
    { id: 'handoff', title: 'Hand off to an attorney', done: !!caseData.attorneyHandoffStatus, locked: false, optional: true, render: () => <HandoffPanel caseData={caseData} /> },
  ];
